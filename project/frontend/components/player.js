import { formatStats } from '../helpers.js';
...
export function renderPlayerStatsInto(container, player) {
  ...
  container.innerHTML = `
    <div class="player-stats">
      ...
      <div class="stat" style="color:#ffd700"><span class="stat-label">Bonuses:</span><span class="stat-value">${formatStats({ bonus_health: player.bonus_health || 0, bonus_attack: player.bonus_damage || 0 })}</span></div>
    </div>`;
}
